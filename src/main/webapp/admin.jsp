...
<body>
	...
	<form action="./newwine" method="post" name="nuevovino" />
	<table style="text-align: left; border: none;">
		<tr>
			<td><input type="hidden" name="varoculta" value="secreto" />
				Nombre:</td>
			<td><input type="text" name="nombrebotella" value="" class="inputgris" /></td>
		</tr>
		<tr>
			<td>Tipo:</td>
			<td><input type="text" name="tipobotella" value="" class="inputgris" /></td>
		</tr>
		<tr>
			<td>Origen:</td>
			<td><input type="text" name="origenbotella" value="" class="inputgris" /></td>
		</tr>
		<tr>
			<td>Envejecimiento</td>
			<td><input type="text" name="edadbotella" value="" class="inputgris" /></td>
		</tr>
		<tr>
			<td>Descripcion:</td>
			<td><input type="text" name="descripcionbotella" value="" class="inputgris" /></td>
		</tr>
		<tr>
			<td>URL de la imagen</td>
			<td><input type="text" name="urlbotella" value="" class="inputgris" /></td>
		</tr>
		<tr>
			<td></td>
			<td style="text-align: right;"><input type="submit" name="send"
				value="Enviar" /></td>
		</tr>
	</table>
	</form><br><br><br>
	
	<h1>Eliminar botella</h1>
	<form action="./delwine" method="post" name="nuevovino" />
	<table style="text-align: left; border: none;">
		<tr>
			<td><input type="hidden" name="varoculta" value="secreto" />
				Nombre:</td>
