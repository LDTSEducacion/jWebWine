...
String query ="select idUsuario from usuarios where usuario=lower('" + usuario + "') and passwd=AES_ENCRYPT('"+ passwd +"','Cl4V3sUpErS3gUr412$?')";
String[][] resultadoquery = null;
resultadoquery=basedatos.resConsultaSelectA3(query);
if (resultadoquery!=null){
	usuok=true;
	basedatos.update("update usuarios set ultimoacceso =now() where id="+resultadoquery[0][0]);
}
